...
class Objetos3D extends JFrame {
    ...
    private double bounceHeight = 1; // Altura máxima del rebote
    private double bounceSpeed = 0.05; // Velocidad del rebote
    private double bouncePosition = 0; // Posición actual del rebote
    ...
    private BranchGroup createSceneGraph() {
        ...
        Sphere sphere = new Sphere(0.3f, Sphere.GENERATE_NORMALS | Sphere.GENERATE_TEXTURE_COORDS, 50,
                createChromeMaterial(new Color3f(0.9f, 0.1f, 0.6f))
        );

        Transform3D spherePosition = new Transform3D();
        spherePosition.setTranslation(new Vector3f(0.8f, 0.0f, -2.0f));
        transformGroupSphere.setTransform(spherePosition);
